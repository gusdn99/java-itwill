...
public class BasicTv {
	...
	public boolean isPowerOn() { // boolean 타입의 getter메서드는 관습상 is를 붙임. 물론 getPowerOn도 가능함.
		return powerOn;
	}
	 ...
	 * @return powerOn의 값.
	 */
	public boolean powerOnOff() { // true - on // false - off
		// switch 못 씀. boolean 타입이라서 -> switch01 참조
		if (powerOn) { // boolean은 필드의 기본값이 false임.
			powerOn = false;
	...
	public int channelUp() {
		if (powerOn) { // TV가 켜져 있을 때만 // boolean은 필드의 기본값이 false임.
