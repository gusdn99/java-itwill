...
// 회사원은 사람이다. (BusinesssPerson IS A Person.)
...
//	하위클래스의 생성자에는 기본적으로 상위클래스의 생성자가 생략되어 있음. (super(); 생략 가능)
//	하위 클래스의 생성자를 만드려면 우선적으로 상위 클래스의 생성자가 만들어져야 함.
//	하위 클래스의 생성자를 호출하면 상위 클래스의 생성자가 먼저 호출되고 그 다음에 하위가 호출됨
