...
//		System.out.println(x); // -> 컴파일 에러 // static 메서드에서 인스턴스 필드를 사용할 수 없음.
	}
	
	@Override
	public String toString() {
		return String.format("EnclosingCls(x=%d, var=%d)", x, var);
		// -> 인스턴스 메서드에서 static 필드를 사용할 수 있음.
	}
