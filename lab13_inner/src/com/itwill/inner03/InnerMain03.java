...
//		OnClickListener clsoeListener = new CloseButtonListener();
//		btnClose.setOnClickListener(clsoeListener);
		...
		// 2. 리스너 구현 객체 생성
		OnClickListener addListener = new OnClickListener() { // 익명 클래스 // 클래스를 선언하면서 객체 생성
			@Override
			public void onClick() {
