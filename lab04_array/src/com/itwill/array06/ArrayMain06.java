...
public class ArrayMain06 {
	...
	public static void main(String[] args) {
		...
		System.out.println(array.length); // -> 2차원 배열의 원소: 1차원 배열. 1차원 배열 개수: 3개 // 행의 개수
		System.out.println(array[0]); // -> [I
		System.out.println(array[0].length); // 열의 개수
		...
		for (int[] a : array) { // 2차원 배열의 원소 - 1차원 배열(a) 
			for (int x : a) { // 1차원 배열(a)의 원소 - int 변수(x)
				System.out.print(x + "\t");
			}
			System.out.println();
		}
