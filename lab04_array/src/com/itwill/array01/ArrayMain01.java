...
public class ArrayMain01 {
	...
	public static void main(String[] args) {
		...
		// 배열(array): "같은" 타입의 데이터 여러 개를 하나의 변수 이름으로 저장하기 위한 타입.
		// 인덱스(index): 배열에 값을 저장하거나, 저장된 값을 읽어올 때 사용하는 정수.
		// - 배열에서 데이터가 저장된 위치를 나타내는 정수.
		// - 인덱스는 0부터(1 아님) 시작하는 연속된 정수.
		// - 배열의 마지막 인덱스는 (배열의 원소 개수 - 1). (예) {100, 90, 95} 원소 개수: 3개, 마지막 인덱스: 2
		...
		// length: 배열의 원소 개수. []안에 있는 정수. 항상 int 타입. 배열타입에서만 length가 있음
		System.out.println("length = " + scores.length); // 변수이름.length
