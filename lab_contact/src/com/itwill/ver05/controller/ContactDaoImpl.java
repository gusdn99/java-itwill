...
// import static 문장: 클래스에서 public static으로 선언된 멤버(필드, 메서드)의 이름을 가져옴. // 클래스 이름을 간단하게 사용.
// import static com.itwill.ver04.util.FileUtil.initializeData;
import static com.itwill.ver05.util.FileUtil.*; // * 의미: FileUtil 클래스에 있는 public static 메서드 전부 다 사용 가능.
...
//		FileUtil.initializeDataDir();
		initializeDataDir(); // static 메서드를 import해서 간단하게 사용.
		// 연락처 데이터 초기화: 데이터 파일에서 리스트를 읽어오거나, 빈 리스트를 생성.
		contacts = initializeData(); // 생성자
	}
