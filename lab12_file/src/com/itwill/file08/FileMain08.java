 ...
 * 		o. "\n": 줄바꿈, "\t": 탭, "\s": 공백, "\\": 백슬래쉬
 * 		o. Windows 파일 경로: "C:\\study\\workspace\\..." 백슬래쉬(\) 2개
...
//		String path = "C:" + File.separator + "study" + File.separator + "workspace" + File.separator + "lab12_file";
		...
		// File 타입 객체 생성 - 파일(과 폴더)을 관리할 수 있는 객체 생성.
		//물리적인 파일과(txt, jpg, mp4, ...) 파일 객체는(File f) 다름.
		...
		System.out.println("파일 크기: " + f.length() + "바이트"); // hello.txt가 77바이트
		...
		if (testFolder.exists()) {
			...
			testFolder.mkdir(); // make directory // 새 폴더 만드는 메서드
