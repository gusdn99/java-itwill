 ...
 * parameter(파라미터, 매개변수, 인자): 아규먼트를 저장하기 위해서 선언하는 "변수". (String[] args) - 파라미터
...
public class MethodMain01 {
	...
	public static void main(String[] args) { // (String[] args) - 파라미터
		
		System.out.println("안녕하세요."); // ("안녕하세요.") - 아규먼트
		// -> println 메서드를 호출.
		...
		int x = rand.nextInt(10); // 괄호() 생략 불가.
