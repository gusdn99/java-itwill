...
public class MethodMain07 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Hello\n"); // argument 1개 // 가변길이 인수 없음
		System.out.printf("안녕하세요, %s\n", "오쌤"); // argument 2개 // 가변길이 인수 1개("오쌤")
		System.out.printf("%d x %d = %d\n", 2, 3, 2 * 3); // argument 4개 // 가변길이 인수 3개(2, 3, 2*3)

		int total = addAll(); // length 없음 // argument 없음
		System.out.println("total = " + total);

		total = addAll(1, 100); // length 2개(1, 100) // argument 2개
		System.out.println("total = " + total);

		total = addAll(1, 3, 5);
		System.out.println("total = " + total);

		int sum = calculate("+", 5, 6, 7);
		System.out.println("sum = " + sum);
		
		int multiply = calculate("*", 3, 4, 5);
