...
public class AppMain08 {
	...
	private void initialize() {
		...
		btnEnter.setBounds(22, 172, 183, 55);
		frame.getContentPane().add(btnEnter);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(32, 237, 424, 253);
		...
		btnDelete.setBounds(273, 172, 183, 55);
	...
	private void deleteScoreFromTable() {
		...
		if (index == -1) { // 테이블에서 선택된 행이 없을 때
			JOptionPane.showMessageDialog(frame, "테이블에서 삭제할 행을 먼저 선택하세요...", "경고", JOptionPane.WARNING_MESSAGE);
			return;
		}
