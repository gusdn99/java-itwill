...
//	private AppMain07 app; // 메인 쓰레드 주소를 저장할 필드
	...
	public void initialize() {
		...
		setBounds(x, y, 487, 372);
		
		if (parentComponent == null) { // 부모 컴포넌트 정보가 없을 때
			setLocationRelativeTo(null); // 항상 화면 중앙에 위치시킴.
		}
		...
		btn.setFont(new Font("D2Coding", Font.PLAIN, 22));
		btn.setBounds(12, 95, 440, 64);
		contentPane.add(btn);
		
		textField = new JTextField();
		textField.setFont(new Font("D2Coding", Font.PLAIN, 22));
		textField.setBounds(12, 10, 440, 64);
