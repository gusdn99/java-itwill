...
public class ModifierMain02 {
	...
	public static void main(String[] args) {
		...
		AccessExample ex = new AccessExample(1, 2, 3, 4); // (1) import 사용했을 때
//		com.itwill.modifier01.AccessExample = new com.itwill.modifier01.AccessExample(1, 2, 3, 4); (2) import 사용하지 않았을 때
//		System.out.println(ex.b); // -> 컴파일 에러: not visible(보이지 않음)
		ex.info(); // 메서드는 public이라서 ex.a, ex.b, ex.c도 보임
