 ...
 * => 파라미터 필요하지 X 필드 멤버변수 이름 앞에 get을 붙여 적음(get 바로 뒤의 글자는 대문자로 적음)
 * setter 메서드: private 필드의 값을 변경하는 메서드.
 * =>파라미터 필요 O 필드 멤버변수 이름 앞에 set을 붙여 적음(set 바로 뒤의 글자는 대문자로 적음)
 */
public class ModifierMain03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("ID: " + member.getMemberId()); // getter
