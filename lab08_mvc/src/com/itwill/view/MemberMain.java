...
public class MemberMain {
	...
	private MemberDao dao = MemberDaoImpl.getInstance(); // 다형성 // 컨트롤러(controller)
...
//        }
		...
		if (index < 0) {
			System.out.println("0 이상의 정수 입력하세요.");
			return;
		} else if (index >= MemberDao.MAX_LENGTH) {
		...
		if (member == null) {
			System.out.println("업데이트할 인덱스 없습니다.");
			return;
		}
...
//            index++;
	...
	private void saveNewMember() {
		...
		// private MemberDaoImpl daoImpl = MemberDaoImpl.getInstance();
